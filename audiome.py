...
INDEX_FILE_NAME = 'audiome.html'
## Regex for matching only image files
IMAGE_FILE_REGEX = '^.+\.(mp3)$'
...
audio_player_html = """// A cross-browser javascript shim for html5 audio
(function(audiojs, audiojsInstance, container) {
  ...
  container[audiojs] = {
    ...
    settings: {
      ...
      loop: false,
      preload: true,
      imageLocation: 'http://kolber.github.io/audiojs/audiojs/player-graphics.gif',
...
def _create_index_file(
    ...
    html = [
        ...
        "      li.playing:before { content: '" + u'\u266B'.encode('utf-8') + "'; width: 14px; height: 14px; padding: 3px; line-height: 14px; margin: 0px; position: absolute; left: -24px; top: 9px; color: #000; font-size: 13px; text-shadow: 1px 1px 0px rgba(0, 0, 0, 0.2); }",
        "      ",
    ...
    for image_file in image_files:
        ...
        html += [
            "<li><a href=\"#\" data-src=\"" + img_src + "\">" + link_target + "</a></li>"
        ]
